...
server.start = function start (opts, cb) {
  ...
  function startServer () {
    http.listen(defaultConfig, function (err, app) {
      ...
      // Note: Due to the structure of the application, certain routes need to be registered here to short-circuit the processing of the request
      ...
      //       Without this lookup table, we'd have to take a performance hit somewhere to redirect, this will minimize request processing time
      var webRoutes = [
        '/files/:method',
        '/:owner/:hook/admin',
        '/:owner/:hook/fork',
