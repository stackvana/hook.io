        ...
        function _spawn () {
          ...
          function _finishSpawn () {
            ...
            */
            ...
            if (untrustedService.themeSource) {
              untrustedService.view = untrustedService.themeSource;
            ...
            function _spawnService (req, res) {
              ...
              hook.spawnService(untrustedService)(req, res, function _serviceEnded (err, result) {
