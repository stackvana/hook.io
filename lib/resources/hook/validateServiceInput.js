...
module['exports'] = function validateServiceInput (req, res, cb) {

  var untrustedSchema = req.untrustedService.schema || {};
  var defaults = mschema.validate(req.resource.params, req.untrustedService.schema || {}, { strict: false });
