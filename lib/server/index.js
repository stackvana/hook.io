...
server.start = function start (opts, cb) {
  ...
  big.spawn('website', {
    ...
    app.get('/:owner/:hook/admin', function (req, res){
      return res.redirect('/admin?owner=' + req.params.owner + '&name=' + req.params.hook + '')
    });

    app.get('/:owner/:hook/:subhook/admin', function (req, res){
      return res.redirect('/admin?owner=' + req.params.owner + '&name=' + req.params.hook + '/' + req.params.subhook)
    });
