...
server.start = function start (opts, cb) {
  ...
  http.listen({
    ...
    app.get('/:owner/:hook/admin', function (req, res){
      return res.redirect('https://hook.io/admin?owner=' + req.params.owner + '&name=' + req.params.hook + '')
    });

    app.get('/:owner/:hook/:subhook/admin', function (req, res){
      return res.redirect('https://hook.io/admin?owner=' + req.params.owner + '&name=' + req.params.hook + '/' + req.params.subhook)
    });
