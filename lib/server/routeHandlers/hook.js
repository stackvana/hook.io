...
var servicePlan = require('../../resources/servicePlan');
...
var errors = {
  ...
  'missing-user-cache': {
    statusCode: 410,
    message: 'Will not route service for unregistered user. If you are seeing this in error please try logging back in to your hook.io account.'
  }
};
...
module['exports'] = function (req, res) {
  ...
  cache.get('/user/' + req.params.owner , function (err, u) {
    ...
    u.servicePlanMeta = u.servicePlanMeta || servicePlan[u.servicePlan] || {
      hits: 1000,
      concurrency: 2
    };
    rateLimiter.middle({
