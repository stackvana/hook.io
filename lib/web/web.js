    ...
    function startServer () {
      ...
      http.listen(defaultConfig, function (err, app) {
        ...
        */
        ...
        app.all('/cron/:owner/:name', function (req, res){
        ...
        app.all('/cron/:owner/:name/destroy', function (req, res){
          req.params.owner = req.params.owner.toLowerCase();
          req.params.name = req.params.name.toLowerCase();
          handleDestroyCron(req, res, app)
        });

        app.all('/cron/:owner/:name/admin', function (req, res){
          req.params.owner = req.params.owner.toLowerCase();
          req.params.name = req.params.name.toLowerCase();
          return res.redirect(config.app.url + '/cron/admin?owner=' + req.params.owner + '&name=' + req.params.name + '');
        });

        var handleCronResource = require('../server/routeHandlers/cronResource');
        app.all('/cron/:owner/:name/resource', function (req, res){
          req.params.owner = req.params.owner.toLowerCase();
          req.params.name = req.params.name.toLowerCase();
