...
sudo mon -d "sudo node bin/services/load-balancer " --log server-log.txt &&

# start three front-end web servers
sudo mon -d "sudo node bin/services/web" --log worker-logs.txt &&
sudo mon -d "sudo node bin/services/web" --log worker-logs.txt &&

# start five workers to run hooks
sudo mon -d "sudo node bin/services/worker" --log worker-logs.txt &&
sudo mon -d "sudo node bin/services/worker" --log worker-logs.txt &&
sudo mon -d "sudo node bin/services/worker" --log worker-logs.txt &&
sudo mon -d "sudo node bin/services/worker" --log worker-logs.txt &&
sudo mon -d "sudo node bin/services/worker" --log worker-logs.txt &&
