module['exports'] = function view (opts, callback) {
  ...
  //    return item.isPublic === undefined || (item.owner !== req.user.username.toLowerCase() && item.isPublic === true);
  //  });
